  ...
  function handle_POST_careLogin(req, res) {
    ...
    .then(function (response) {
      ...
      if (response.status == 'ok') {
        ...
        errorMessage = "<div style=color:red>Invalid Username or password. <a href='javascript:void(0)' onclick='window.history.back();'>Try Again</div>"
...
input[type=submit] {
  ...
  outline: 0;
      ...
      <div class="login-help">
        <p>Forgot your password? <a href="https://care.or.th/password-reset/" target="_blank">Click here to reset it</a>.</p>
      </div>
